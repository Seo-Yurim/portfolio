...
export function EducationCard() {
  return (
    <motion.div
      ...
      className={`flex flex-col gap-4 rounded-2xl bg-primary/20 p-6 dark:bg-blue-200/60`}
    >
      ...
      <div className="flex gap-4 pt-4">
        ...
        <div className="h-full border-r border-text-secondary/30" />
